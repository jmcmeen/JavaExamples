...
/**
 * Class Name: ComparisonOperators
 * Purpose: Demonstrates basic comparison operators using integer variables
 * References:
...
public class ComparisonOperators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Is " + intOperand1 + " == " + intOperand2 + " : " + result);
